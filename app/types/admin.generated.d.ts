...
export type GetVideoByIdQuery = { node?: AdminTypes.Maybe<(
    Pick<AdminTypes.Video, 'id' | 'alt' | 'filename' | 'duration' | 'createdAt' | 'fileStatus'>
    & { fileErrors: Array<Pick<AdminTypes.FileError, 'code' | 'details' | 'message'>>, originalSource?: AdminTypes.Maybe<Pick<AdminTypes.VideoSource, 'fileSize' | 'format' | 'width' | 'height'>>, sources: Array<Pick<AdminTypes.VideoSource, 'format' | 'height' | 'mimeType' | 'url' | 'width'>>, preview?: AdminTypes.Maybe<(
